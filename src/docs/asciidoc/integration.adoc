...
----
org.sp.Person person = restTemplate.getForObject("https://example.com/people/{id}", org.sp.Person.class, 42);
----
...
----
	...
	parts.add("jsonPart", new org.sp.Person("Jason"));
...
to an instance of the `org.sp.Person` class:
...
----
	public class PersonMappingOperation extends MappingRecordOperation {
		...
		protected Object extractOutputData(Record outputRecord)
			...
			org.sp.Person person = null;
			if (rs.next()) {
				org.sp.Person person = new org.sp.Person();
...
----
	public class MyDaoImpl extends CciDaoSupport implements MyDao {
		...
		public org.sp.Person getPerson(int id) {
			PersonMappingOperation query = new PersonMappingOperation(getConnectionFactory());
			org.sp.Person person = (org.sp.Person) query.execute(new Integer(id));
			return person;
		}
	}
----
