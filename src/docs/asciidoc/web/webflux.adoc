...
----
	...
	class PersonController {
		...
		@GetMapping("/{id}")
		public org.sp.Person getPerson(@PathVariable Long id) {
			// ...
		}

		@PostMapping
		@ResponseStatus(HttpStatus.CREATED)
		public void add(@RequestBody org.sp.Person person) {
			// ...
		}
	}
----
...
----
	...
	class PersonController {
		...
		@GetMapping("/{id}")
		fun getPerson(@PathVariable id: Long): org.sp.Person {
			// ...
		}

		@PostMapping
		@ResponseStatus(HttpStatus.CREATED)
		fun add(@RequestBody person: org.sp.Person) {
			// ...
		}
	}
----
