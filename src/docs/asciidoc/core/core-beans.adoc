...
----
	<bean id="outer" class="...">
		...
		<property name="target">
			<bean class="com.example.org.sp.Person"> <!-- this is the inner bean -->
...
----
	<beans xmlns="http://www.springframework.org/schema/beans"
		...
		<bean name="john-classic" class="com.example.org.sp.Person">
			<property name="name" value="John Doe"/>
			<property name="spouse" ref="jane"/>
		</bean>

		<bean name="john-modern"
			class="com.example.org.sp.Person"
			p:name="John Doe"
			p:spouse-ref="jane"/>

		<bean name="jane" class="com.example.org.sp.Person">
...
----
	@EventListener
	public void onPersonCreated(EntityCreatedEvent<org.sp.Person> event) {
		// ...
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	@EventListener
	fun onPersonCreated(event: EntityCreatedEvent<org.sp.Person>) {
		// ...
	}
----
...
`class PersonCreatedEvent extends EntityCreatedEvent<org.sp.Person> { ... }`).
