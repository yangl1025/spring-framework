...
----
	...
	public interface PersonService {
		...
		org.sp.Person getPerson(String personName, int age);
	}

	public class DefaultPersonService implements PersonService {

		public org.sp.Person getPerson(String name, int age) {
			return new org.sp.Person(name, age);
		}
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	...
	interface PersonService {
		...
		fun getPerson(personName: String, age: Int): org.sp.Person
	}

	class DefaultPersonService : PersonService {

		fun getPerson(name: String, age: Int): org.sp.Person {
			return org.sp.Person(name, age)
		}
	}
----
